...
export const TOOL_INFO: Record<Tool, ToolInfo> = {
  ...
  bulldoze: { name: msg('Bulldoze'), cost: 5000, description: msg('Remove buildings and zones') },
  road: { name: msg('Road'), cost: 5000, description: msg('Connect your city') },
  rail: { name: msg('Rail'), cost: 30000, description: msg('Build railway tracks') },
  subway: { name: msg('Subway'), cost: 45000, description: msg('Underground transit') },
  ...
  tree: { name: msg('Tree'), cost: 12000, description: msg('Plant trees to improve environment') },
  zone_residential: { name: msg('Residential'), cost: 25000, description: msg('Zone for housing') },
  zone_commercial: { name: msg('Commercial'), cost: 35000, description: msg('Zone for shops and offices') },
  zone_industrial: { name: msg('Industrial'), cost: 50000, description: msg('Zone for factories') },
  ...
  police_station: { name: msg('Police'), cost: 100000, description: msg('Increase safety'), size: 1 },
  fire_station: { name: msg('Fire Station'), cost: 100000, description: msg('Fight fires'), size: 1 },
  hospital: { name: msg('Hospital'), cost: 160000, description: msg('Improve health (2x2)'), size: 2 },
  school: { name: msg('School'), cost: 90000, description: msg('Basic education (2x2)'), size: 2 },
  university: { name: msg('University'), cost: 180000, description: msg('Higher education (3x3)'), size: 3 },
  park: { name: msg('Small Park'), cost: 45000, description: msg('Boost happiness and land value (1x1)'), size: 1 },
  park_large: { name: msg('Large Park'), cost: 120000, description: msg('Large park (3x3)'), size: 3 },
  ...
  museum: { name: msg('Museum'), cost: 140000, description: msg('Boosts commercial & residential demand (3x3)'), size: 3 },
  airport: { name: msg('Airport'), cost: 500000, description: msg('Boosts commercial & industrial demand (4x4)'), size: 4 },
  space_program: { name: msg('Space Program'), cost: 420000, description: msg('Boosts industrial & residential demand (3x3)'), size: 3 },
  city_hall: { name: msg('City Hall'), cost: 180000, description: msg('Boosts all demand types (2x2)'), size: 2 },
  amusement_park: { name: msg('Amusement Park'), cost: 280000, description: msg('Major boost to commercial demand (4x4)'), size: 4 },
...
export interface GameState {
  ...
  activePanel: 'none' | 'budget' | 'statistics' | 'advisors' | 'settings' | 'challenge';
...
export interface NpsChallengeState {
  mode: 'season' | 'freebuild';
  seasonName: string;
  startedAt: number;
